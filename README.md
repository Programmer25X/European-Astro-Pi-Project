...
## Overview 
In 2023, I was fortunate to have the opportunity to partake in the European Astro Pi Challenge. Over the course of two months, [Artemii Teplov](https://www.linkedin.com/in/artemii-teplov-5607b7366/?originalSubdomain=uk) and I were able to successfully develop a program written in the *Python* programming language that estimated the average speed of the ISS. Our program was successfully executed on the ISS in 2024. We later received certifications from the ESA and the data that was gathered when the program was executed on the ISS.
